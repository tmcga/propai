      ...
      {tiles.map((t) => (
        <div key={t.label} className="card-sm flex flex-col gap-1">
          ...
          <span
            className={cn(
              "text-xl font-bold",
              t.good === true ? "text-emerald-400" :
              t.good === false ? "text-red-400" :
              "text-slate-100"
            )}
          >
            {t.value}

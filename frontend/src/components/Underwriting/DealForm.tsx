...
const schema = z.object({
  ...
  // Loan
  loan_ltv: z.coerce.number().min(0).max(0.95).default(0.7),
  loan_interest_rate: z.coerce.number().min(0).max(0.2).default(0.0675),
  ...
  management_fee_pct: z.coerce.number().min(0).max(0.2).default(0.05),
  ...
  exit_cap_rate: z.coerce.number().min(0.01).max(0.2).default(0.055),
  selling_costs_pct: z.coerce.number().min(0).max(0.1).default(0.03),
  discount_rate: z.coerce.number().min(0.01).max(0.3).default(0.08),
});
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              type="number"
              placeholder="30"
              {...register("loan_amortization_years")}
            />
          </div>
          <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              type="number"
              placeholder="576000"
              {...register("gross_scheduled_income")}
            />
          </div>
          <div>
